...
För att kunna detektera RFID-taggen så krävs en sensor. Vi kommer att använda Parallax-Reader\footnote{https://docs.isy.liu.se/twiki/pub/VanHeden/DataSheets/rfid-reader-v21.pdf}. 
...
\begin{figure}[htp] %Placera här om det finns plats, annars så snart som möjligt, på toppen av en sida.
  \begin{center}
  \includegraphics[keepaspectratio=true,scale=0.4]{kopplingsschema_styrmodul.png}  %skala och filnamn. 
  \end{center}
