...
Inom reglerteknik kan linjära system beskrivas på så kallad tillståndsformel så som Glad och Ljung\footnote{Glad, Torkel och Ljung, Lennart (2006), \textit{Reglerteknik - Grundläggande teori}.} beskriver. I fallet med SLAM för en robot använder man robotens position i förhållande till kringliggande objekt som tillstånd , tecknat $x$. 
\\
...
Ett reglersystem på tillståndsform kan skrivas enligt: 
...
Systemets tillstånd är generellt en kort period där robotens position kan antas vara konstant. För att skatta nästkommande tillstånd används inom SLAM ofta en observatör som kallas Kalmanfilter. 
