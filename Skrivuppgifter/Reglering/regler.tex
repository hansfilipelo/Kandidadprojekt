...
Sett från det perspektiv vi granskar SLAM-problemet, genom ögonen på en grupp människor som gör ett kandidatprojekt på 16 hp, är avancerade FastSLAM-algoritmer för stora att implementera. Någon typ av filter måste alltid finnas i en SLAM-implementering, i fall där beräkningar man gjort ger konflikt med varandra huruvida en vägg faktiskt finns där eller ej. Enklare fall av FastSLAM kommer alltså behöva lösas vid en framtida implementering. 
