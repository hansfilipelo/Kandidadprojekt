...
Simultan positionering och kartläggning (SLAM) är ett problem som kan liknas vid "Hönan och ägget"-problemet. Utan att veta var vi är - hur kartlägger vi då vår omgivining? Åt andra hållet får man ställa sig frågan - hur kartlägger vi vår omgivning utan att veta var vi är? 
...
Själva problemet är alltså inte entydigt löst rent matematiskt, utan bygger på sannolikhetsteori i kombination med att moderna processorer och minnen kan hantera en stor mängd data - alltså är det möjligt att få ett stort stickprov och en liten osäkerhet. 
...
http://www.frc.ri.cmu.edu/~hpm/project.archive/reference.file/Smith&Cheeseman.pdf
