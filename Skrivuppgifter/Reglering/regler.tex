...
En observatör används för att skatta positionen i förhållande till kringliggande objekt med hjälp av till exempel sensorvärden. 


\subsection{Kalmanfilter}

\subsection{EKF - Det utökade kalmanfiltret}
