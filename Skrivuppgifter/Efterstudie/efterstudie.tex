...
Att oscilloskopet är ett bra verktyg har vi alltid förstått, men under projektets gång insåg vi hur viktigt det var vid felsökning. Det underlättade analys av flera signaler parallellt vilket gjorde det möjligt att bland annat se så att den data som skickades ut på bussen även togs emot på rätt sätt.

Det är svårt att implementera buss
Starkare huvudprocessor för klasstruktur och beslut, med dotterprocessorer för utförande.
