...
Roboten uppfyller i princip alla krav av högsta prioritet som ställts och även en del av lägre prioritet. Bland annat så kan roboten i 25\% av försöken kartlägga ett område helt korrekt och finna ett flertal brandhärdar och markera ut dem på kartan. Kartan ritas då upp i PC-mjukvaran tillsammans med grafer för den senaste sensordatan.
