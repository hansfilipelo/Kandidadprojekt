...
Den litteratur som använts under projektets gång består till stor del av böcker inom grunderna för bland annat sannolikhetslära, datorteknik, elektronik, reglerteknik\footnote{Glad, Torkel och Ljung, Lennart. 2006. \textit{Reglerteknik - Grundläggande teori}. Upplaga 4:10. Lund. Studentlitteratur.} och matematisk analys. 
...
De dokument som producerades under planeringsfasen så som systemskiss och projektplan skrevs gemensamt för att alla medlemmar skulle få en så bra inblick som möjligt i hur arbetet planerades. 
...
Det har bland annat inneburit förberedande design av delprodukt (Se Designspecifikation) och implementering. Vid ett delprojekts slutförande har hårdvaran eller den skrivna koden förklarats för övriga projektmedlemmar och sedan integrerats med resten av projektet. 

För att på ett smidigt vis slå samman kod och möjliggöra simultan programmering har en mjukvara för versionshantering vid namn Git\footnote{Git Source Control Management, \url{http://git-scm.com/}, hämtad 2014-05-19} använts tillsammans med ett kodförvar hos molntjänsten GitHub\footnote{hansfilipelo/MapMaster2001, \url{https://github.com/hansfilipelo/MapMaster2001}, hämtad 2014-05-19}. 

När hårdvara skulle utvecklas delades projektgruppen in modulvis, två personer per modul. Dialog hölls mellan grupperna för att säkerställa att portar och kontakter för gränssnitt mellan olika komponenter implementerades med störningsminimering och platsoptimering i åtanke.

Längre in i projektet ändrades grupperna något för att ge alla projektmedlemmar en chans att arbeta med varandra, men också för att bättre kunna utnyttja unik spetskompetens hos gruppmedlemmarna på ett bättre sätt. I slutfasen av projektet turades gruppmedlemarna om att skriva den tekniska dokumentationen medan andra arbetade med roboten för att effektivisera arbetet.
...
Roboten har implementerats med tre stycken AVR Atmega 1284p-processorer, med en kommunikationsbuss över SPI-länk\footnote{Datablad för Atmega 1284p \url{https://docs.isy.liu.se/twiki/pub/VanHeden/DataSheets/atmega1284p.pdf}, hämtad 2014-05-19}. En processor hanterar sensorer, en processor hanterar styrning och en processor agerar kommunikationslänk mellan de två förstnämnda samt en persondatormjukvara över Bluetooh. 
...
För att styra chassits motorer används AVR-processorn inbyggda pulsbreddsmodulering, PWM. Den som använts är en 8-bitars PWM, det vill säga att den styrs med mellan mellan 0 och 255 där 0 innebär att motorerna inte körs och där 255 leder till att roboten kör med 100\% av sin maxhastighet. 
