...
För mer information om hur sensorer används för att bedöma avstånd se appendix C i kappan och dokumentet \textit{''Sensorers applikation för kartritande robot''}\footnote{Ekelund, E. Habrman, D (2014), \textit{''Sensorers applikation för kartritande robot''}}.
