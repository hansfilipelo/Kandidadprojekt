...
\section{Persondatormjukvara}
Det grafiska gränssnittet är skrivet i Qt 5.3.0 och är designat i QtCreator. Mjukvaran är skriven för att vara kompatibel med Mac OS X.
...
\begin{itemize}
	...
	\item Mellanslag - Roboten stannar
\end{itemize}
