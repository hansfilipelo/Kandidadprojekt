...
%Ta bort ack ur Fall1 och 2 i flödesscheman.
...
Styrmodulen får sensor-data skickad till sig från sensormodulen. Detta data används till att reglera riktningen då man följer en vägg.
