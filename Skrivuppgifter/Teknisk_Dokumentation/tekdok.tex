...
Den andra proportionella regleringen försöker minimera differensen mellan de båda sensorerna på högersidan. Detta innebär i praktiken att roboten försöker räta ut sig. Denna typ av reglering medför även en minskad risk att de främre och bakre sensorerna ska fel värden genom att slå i en sidovägg pga. lutning.
...
Konstanterna $K_{p}$ och $K_{d}$ kan dels väljas i persondators mjukvara, men de initieras som standard till $K_{p}=6$ och $K_{d}=7$.
