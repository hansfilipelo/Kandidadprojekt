...
\subsection{Trådlös kommunikation med robot}
För den trådlösa kommunikationen med roboten används Bluetooth. En kortare rapport angående olika typer av trådlös kommunikation finns att tillgå i fördjupningsuppgiften \emph{Kommunikation} som kan hittas i Kappan - Appendix A
...
GP2D120 som går att läsa om på Vanheden\footnote{\url{https://docs.isy.liu.se/twiki/pub/VanHeden/DataSheets/gp2d120.pdf}}. Ett byte av sensorer skulle kunna innebära större begränsningar vid kartläggning - men vid nuvarande implementering är det ej en faktor.
...
Orsaken till att roboten endast utför 90graders svängar är för att kartläggningen ska bli korrekt i manuellt läge. Utöver detta kan du även sätta vilken hastighet du vill att roboten ska köra i. Detta gör du med slidern ''speed'' i programvaran. Se figur 2. 
